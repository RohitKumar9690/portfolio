  ...
  return (
      <div className="about-container" id={id}>
        <div className="aboutMe-text">
          ...
          <br/> <br/>
          Want to know more about me? Feel free to <a className='resume' href="https://drive.google.com/file/d/1yIjukQyN1TS4lOYAf_t9TmiajeDFji4N/view?usp=drive_link" target="_blank" rel="noopener noreferrer">explore my resume.</a>
        </div>
