  ...
  return (
      <div className="about-container" id={id}>
        <div className="aboutMe-text">
          ...
          <br/> <br/>
          Want to know more about me? Feel free to <a className='resume' href="https://drive.google.com/file/d/1ry9US9sV0uOlm3duxx1uRm5bfykZc3a3/view?usp=sharing" target="_blank" rel="noopener noreferrer">explore my resume.</a>
        </div>
